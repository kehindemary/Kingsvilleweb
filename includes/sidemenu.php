<div class="sidebar">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div class="latest-research-img">
                                                    <a href="#"><img src="<?php echo $news['image_location'] ?>" class="img-responsive" style="height:100px;"></a>
                                                </div>
                            ...
                            <div class="sidebar-box">
                                <div class="sidebar-box-inner">
                                    <h3 class="sidebar-title">Online Registration</h3>
                                    <?php foreach(getLibrary() as $lib){ ?>
                                    <?php if($lib['type'] == "admission"){ ?>
                                    <a href="enrollment.php" class="sidebar-ghost-btn">Enroll Here</a>
                                    <?php } ?>
                                    <?php } ?>
                                </div>
                            </div>
                            ...
                            <div class="sidebar-box">
                                <div class="sidebar-add-area overlay-primaryColor">
                                    ...
                                    <a href="admission-form.php" class="sidebar-ghost-btn">Enroll Now</a>
                                </div>
                            </div>
                        </div>